function [ a0, a1, a2, a3 ] = get_order4_param_estimates( t_array, a, b, y_n, max_count )
    V5 = 0; V6 = 0; V7 = 0; V8 = 0; V9 = 0; V10 = 0; V11 = 0; V12 = 0; V13 = 0; 
    V14 = 0; V15 = 0; V16 = 0; V17 = 0; V18 = 0; V19 = 0; V20 = 0; V21 = 0;
    V22 = 0; V23 = 0; V24 = 0;

    %Parameter estimation using K_DS | code obtained from CH_ReproducingKernels_15.m
...
%         Num = Num+1;
    ...
    %     V4 = -((t_i-a).^4+(b-t_i).^4)*y(i) + quadgk(@(t,v)myfun_RK_37(t,t_array,y_n,t_i, a),a,t_i,'MaxIntervalCount',max_count) + quadgk(@(t,v)myfun_RK_38(t,t_array,y_n,t_i, b),t_i,b,'MaxIntervalCount',max_count) ;
        ...
        V5 = V5 + V0*W0; V6 = V6 + V1*W0; V7 = V7 + V2*W0;
        V8 = V8 + V3*W0; V9 = V9 + V4*W0; V10 = V10 + V0*W1;
        V11 = V11 + V1*W1; V12 = V12 + V2*W1; V13 = V13 + V3*W1;
        V14 = V14 + V4*W1; V15 = V15 + V0*W2; V16 = V16 + V1*W2;
        V17 = V17 + V2*W2; V18 = V18 + V3*W2; V19 = V19 + V4*W2;
        V20 = V20 + V0*W3; V21 = V21 + V1*W3; V22 = V22 + V2*W3;
        V23 = V23 + V3*W3; V24 = V24 + V4*W3;
    end
