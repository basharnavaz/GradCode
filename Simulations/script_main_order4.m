...
parfor (count = 51:451)
    ...
    [y_est_win, y_dot_est_win, y_ddot_est_win] = estimate_order4_output(t_array(start_pt:end_pt), y_n(start_pt:end_pt), t_array(start_pt), t_array(end_pt), estimated_params, max_count);
    y_est(count) = y_est_win(25);
    y_dot_est(count) = y_dot_est_win(25);
    y_ddot_est(count) = y_ddot_est_win(25);
